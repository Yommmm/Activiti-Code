 ...
 */
public class ProxyHttpBase {

    private static Logger log =  LoggerFactory.getLogger(ProxyHttpBase.class);
    ...
    public ProxyHttpBase(String apiIpStr, String apiUrlStr, String methodTypeStr, String paramsStr){
     ...
     * @return
     */
    private ClientRestFulRequest processRequestObject(DelegateExecution execution){
        //拼接当前流程节点访问外部Rest服务的参数
        String orderId = execution.getVariable(ORDER_ID)==null?"":execution.getVariable(ORDER_ID).toString();
        if(orderId==null||"".equals(orderId)){
            return null;
     ...
     * @param execution
     */
    private void prepareHttpContent(DelegateExecution execution){
     ...
     */
    private void prepareListenerHttpContent(DelegateTask delegateTask){
