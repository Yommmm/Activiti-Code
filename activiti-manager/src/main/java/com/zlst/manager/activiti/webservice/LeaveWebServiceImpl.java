package com.zlst.manager.activiti.webservice;
 ...
 * @author: Henry Yan
 */
@WebService(endpointInterface = "com.zlst.manager.activiti.webservice.LeaveWebService", serviceName = "LeaveWebService")
