package com.zlst.manager.activiti.conf;
...
import com.zlst.manager.activiti.util.PropertyFileUtil;
...
public class DemoDataInitConfig {
    ...
    protected void initDemoUsers() {
        createUser("admin", "Administrator", "me", "000000", "administrator.me@zlst.com",
                "", Arrays.asList("user", "admin"), null);

        createUser("hruser", "Lili", "Zhang", "000000", "lili.zhang@zlst.com",
                "", Arrays.asList("hr", "user"), null);

        createUser("leaderuser", "Jhon", "Li", "000000", "jhon.li@zlst.com",
                "", Arrays.asList("deptLeader", "user"), null);

        createUser("kafeitu", "Coffee", "Rabbit", "000000", "coffee.rabbit@zlst.com",
                "", Arrays.asList("user", "admin"), null);
    }
