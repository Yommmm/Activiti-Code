function graphTrace(options) {
    ...
    $('#changeImg').live('click', function() {
        ...
        $('<div/>', {
            ...
            html: "<img src='" + ctx + '/workflow/resource/high-process-instance?pid=' + opts.pid + "&type=image' />"
    ...
    var imageUrl = ctx + "/workflow/resource/high-process-instance?pid=" + opts.pid + "&type=image";
