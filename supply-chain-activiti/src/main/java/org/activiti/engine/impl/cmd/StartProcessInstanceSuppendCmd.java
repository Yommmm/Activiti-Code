...
public class StartProcessInstanceSuppendCmd implements Command<ProcessInstance> {
    ...
    public StartProcessInstanceSuppendCmd(String processDefinitionKey, String processDefinitionId, String businessKey, Map<String, Object> variables) {
    ...
    public StartProcessInstanceSuppendCmd(String processDefinitionKey, String processDefinitionId,
    ...
    public StartProcessInstanceSuppendCmd(ProcessInstanceBuilderImpl processInstanceBuilder) {
