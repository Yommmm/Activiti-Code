...
import com.zlst.module.logistics.dao.LogisticsOrderRepository;
...
import com.zlst.module.order.bean.vo.SysRoleVo;
...
import com.zlst.utils.RestConstants;
 ...
 */
@Service
public class LogisticsOrderService extends QueryAndOperateServ<OmsTaskInstance, LogisticsOrderRepository> {
...
//        filtersAll.setGroups(filtersList);
    ...
    public String queryByStatusAndOrderId(String orderId){
        List<OmsTaskInstance> omsTaskInstances = logisticsOrderRepository.queryByStatusAndOrderId("0", orderId);
